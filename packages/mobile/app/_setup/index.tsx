...
export default function SetupScreen() {
    ...
    const renderIntroStep = () => (
        <Surface style={{ flex: 1, padding: 24, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Button mode="contained" onPress={() => { void handleNextFromIntro() }}>
                Continue
            </Button>
        </Surface>
    );
    ...
    const renderCompleteStep = () => (
        <Surface style={{ flex: 1, padding: 24, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Button mode="contained" onPress={() => { void completeSetup() }}>
                Continue
            </Button>
        </Surface>
    );
