        ...
        <Surface style={{ flex: 1 }}>
            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16 }}>
                ...
                <Text variant="bodyMedium" style={{ marginBottom: 8 }}>
                    ...
                    - Wirelessly recieve signature requests from connected wallets.
                    <Divider style={{ marginVertical: 8 }} />
                ...
                <Text variant="bodyMedium" style={{ marginBottom: 8 }}>
                    ...
                    <Divider style={{ marginVertical: 8 }} />
                    - Seed phrase is generated on-device and stored in `expo-escure-store`.  Authentication is required to load the seed phrase from secure storage or to write a new seed phrase to store.  All other actions are permitted without authentication.  IMO this strikes a good balance between usability and security.
                </Text>
